...
files from your User Data, and put a copy of them in the same folder as this script and it will hopefully recover
your open tabs in the form of a bookmarks file that you can import into Edge and use to restore your open tabs.
The script will create a bookmarks folder for each tab group.
